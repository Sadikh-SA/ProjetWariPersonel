...
class Compte extends \App\Entity\Compte implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'numeroCompte', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'codeBank', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'nomBeneficiaire', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'montant', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'idPartenaire', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'depots', '' . "\0" . 'App\\Entity\\Compte' . "\0" . 'utilisateurs'];
        }
     ...
     * {@inheritDoc}
     */
    public function setCodeBank(float $codeBank): \App\Entity\Compte
    {
    ...
    public function getNomBeneficiaire(): ?string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNomBeneficiaire', []);

        return parent::getNomBeneficiaire();
    }

    /**
     * {@inheritDoc}
     */
    public function setNomBeneficiaire(string $nomBeneficiaire): \App\Entity\Compte
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNomBeneficiaire', [$nomBeneficiaire]);

        return parent::setNomBeneficiaire($nomBeneficiaire);
    }
